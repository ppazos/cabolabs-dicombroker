<html>
  ...
  <body>
          ...
          <tr>
            ...
            <g:each in="${pacsList}" var="pacs">
              <td>
                ...
                <div><g:checkBox name="pacsSecurity" value="${false}" data-user_id="${doctor.id}" data-pacs_id="${pacs.id}" /></div>
              </td>
            </g:each>
          </tr>
        </g:each>
    ...
    $(document).ready(function() {
      ...
      $("[name=pacsSecurity]").click( function() {
